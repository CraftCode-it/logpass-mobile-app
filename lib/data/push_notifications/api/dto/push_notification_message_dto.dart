...
class PushNotificationMessageDTO with _$PushNotificationMessageDTO {
  ...
  factory PushNotificationMessageDTO.authorize(String sendAttemptId, PushNotificationAuthorizeDTO body) =
      _PushNotificationMessageDTOAuthorize;

  @FreezedUnionValue('unknown')
  factory PushNotificationMessageDTO.unknown(String sendAttemptId, String action) = _PushNotificationMessageDTOUnknown;
