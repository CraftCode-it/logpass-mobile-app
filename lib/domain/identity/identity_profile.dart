...
class IdentityProfile {
  ...
  static IdentityProfile defaultPrivate() => IdentityProfile(
        ...
        fields: [
          ...
          IdentityField(
            key: IdentityFieldKey.address,
            label: IdentityFieldKey.label(IdentityFieldKey.address),
            value: '',
            isLocked: false,
          ),
          IdentityField(
            key: IdentityFieldKey.invoiceData,
            label: IdentityFieldKey.label(IdentityFieldKey.invoiceData),
            value: '',
            isLocked: false,
          ),
        ],
